...
# direct methods
.method public static final a(Lca/y;)Lp8/d0;
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterUtilsKt;->b(Lca/y;Lp8/e;I)Lp8/d0;
...
.method private static final b(Lca/y;Lp8/e;I)Lp8/d0;
    .locals 5
    ...
    invoke-direct {v1, p1, p0, v0}, Lp8/d0;-><init>(Lp8/e;Ljava/util/List;Lp8/d0;)V
    ...
    .line 9
    invoke-direct {v2, p1, p2, p0}, Lp8/d0;-><init>(Lp8/e;Ljava/util/List;Lp8/d0;)V
...
.method private static final c(Lp8/n0;Lp8/h;I)Lkotlin/reflect/jvm/internal/impl/descriptors/b;
    .locals 1

    .line 1
    new-instance v0, Lkotlin/reflect/jvm/internal/impl/descriptors/b;

    invoke-direct {v0, p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/descriptors/b;-><init>(Lp8/n0;Lp8/h;I)V

    return-object v0
.end method

.method public static final d(Lp8/e;)Ljava/util/List;
    .locals 7
    ...
    .line 1
    invoke-interface {p0}, Lp8/e;->p()Ljava/util/List;
    ...
    .line 3
    :cond_0
    invoke-static {p0}, Lkotlin/reflect/jvm/internal/impl/resolve/descriptorUtil/DescriptorUtilsKt;->m(Lp8/h;)Lla/f;
    ...
    invoke-static {v2, v3}, Lkotlin/sequences/d;->x(Lla/f;La8/l;)Lla/f;
    ...
    invoke-static {v2, v3}, Lkotlin/sequences/d;->n(Lla/f;La8/l;)Lla/f;
    ...
    invoke-static {v2, v3}, Lkotlin/sequences/d;->r(Lla/f;La8/l;)Lla/f;

    move-result-object v2

    .line 6
    invoke-static {v2}, Lkotlin/sequences/d;->z(Lla/f;)Ljava/util/List;
    ...
    .line 8
    invoke-interface {v3}, Lla/f;->iterator()Ljava/util/Iterator;
    ...
    :cond_3
    invoke-interface {v4}, Lp8/d;->h()Lca/l0;
    ...
    invoke-static {v3, p0, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterUtilsKt;->c(Lp8/n0;Lp8/h;I)Lkotlin/reflect/jvm/internal/impl/descriptors/b;
