...
.method public static a(Ljava/util/List;Ljava/util/Map;)Ljava/util/List;
    ...
    const-string v0, "waterfallFromServer"
    ...
    invoke-static {p0, v0}, Lkotlin/collections/h;->A0(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public final c(Ljava/util/List;Ljava/util/Map;)Lcom/ironsource/mediationsdk/adunit/e/g;
    ...
    const-string v1, "waterfallFromServer"
    ...
    iget-boolean v3, v2, Lcom/ironsource/mediationsdk/adunit/c/a/a;->d:Z

    if-eqz v3, :cond_0

    sget-object v3, Lcom/ironsource/mediationsdk/adunit/e/e;->b:Lcom/ironsource/mediationsdk/adunit/e/e;

    goto :goto_0

    :cond_0
    sget-object v3, Lcom/ironsource/mediationsdk/adunit/e/e;->a:Lcom/ironsource/mediationsdk/adunit/e/e;

    :goto_0
    sget-object v4, Lcom/ironsource/mediationsdk/adunit/e/h;->a:Lcom/ironsource/mediationsdk/adunit/e/h$a;

    iget v6, v2, Lcom/ironsource/mediationsdk/adunit/c/a/a;->b:I

    const-string v2, "loadingStrategy"
    ...
    invoke-direct/range {v5 .. v10}, Lcom/ironsource/mediationsdk/adunit/e/a;-><init>(ILjava/util/List;Ljava/util/Map;ZI)V
    ...
    invoke-direct {v0, v6, p1, p2}, Lcom/ironsource/mediationsdk/adunit/e/b;-><init>(ILjava/util/List;Ljava/util/Map;)V
