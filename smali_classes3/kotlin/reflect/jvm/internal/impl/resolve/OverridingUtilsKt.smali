...
# direct methods
.method public static final a(Ljava/util/Collection;La8/l;)Ljava/util/Collection;
    .locals 8
    ...
    .line 3
    sget-object p0, Lka/e;->c:Lka/e$b;

    invoke-virtual {p0}, Lka/e$b;->a()Lka/e;
    ...
    invoke-virtual {v3}, Lka/e$b;->a()Lka/e;
    ...
    invoke-direct {v4, v3}, Lkotlin/reflect/jvm/internal/impl/resolve/OverridingUtilsKt$selectMostSpecificInEachOverridableGroup$overridableGroup$1;-><init>(Lka/e;)V

    invoke-static {v2, v0, p1, v4}, Lkotlin/reflect/jvm/internal/impl/resolve/OverridingUtil;->q(Ljava/lang/Object;Ljava/util/Collection;La8/l;La8/l;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2}, Lka/e;->add(Ljava/lang/Object;)Z

    goto :goto_0

    .line 10
    :cond_1
    invoke-static {v2, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/OverridingUtil;->M(Ljava/util/Collection;La8/l;)Ljava/lang/Object;
    ...
    .line 11
    invoke-interface {p1, v4}, La8/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, La8/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 16
    :cond_4
    invoke-virtual {p0, v4}, Lka/e;->add(Ljava/lang/Object;)Z
