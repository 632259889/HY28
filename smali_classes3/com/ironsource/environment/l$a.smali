...
.method public static synthetic a(Lcom/ironsource/mediationsdk/utils/o;Landroid/content/Context;)Lorg/json/JSONObject;
    .locals 5

    iget-boolean v0, p0, Lcom/ironsource/mediationsdk/utils/o;->d:Z
    ...
    :cond_0
    iget-object p1, p0, Lcom/ironsource/mediationsdk/utils/o;->b:Lcom/ironsource/mediationsdk/model/NetworkSettings;
    ...
    iget-object v1, p0, Lcom/ironsource/mediationsdk/utils/o;->c:Lorg/json/JSONObject;

    iget-object p0, p0, Lcom/ironsource/mediationsdk/utils/o;->a:Ljava/util/ArrayList;

    invoke-static {}, Lcom/ironsource/mediationsdk/X;->a()Lcom/ironsource/mediationsdk/X;

    move-result-object v2

    invoke-static {}, Lcom/ironsource/mediationsdk/X;->c()Lorg/json/JSONObject;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/ironsource/mediationsdk/X;->a(Lorg/json/JSONObject;)V

    invoke-static {}, Lcom/ironsource/mediationsdk/X;->b()Lorg/json/JSONObject;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/ironsource/mediationsdk/X;->a(Lorg/json/JSONObject;)V

    iget-object v2, v2, Lcom/ironsource/mediationsdk/X;->a:Lorg/json/JSONObject;
    ...
    :goto_0
    invoke-static {v2, v3}, Lcom/ironsource/mediationsdk/d;->a(Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;

    move-result-object v2

    invoke-virtual {v0, p1, p0}, Lcom/ironsource/mediationsdk/d;->b(Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;

    move-result-object p1

    invoke-virtual {v0, v2, p1}, Lcom/ironsource/mediationsdk/d;->a(Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    ...
    :cond_2
    invoke-static {v1, p0}, Lcom/ironsource/mediationsdk/d;->a(Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;

    move-result-object v1

    :goto_1
    invoke-virtual {v0, v2, v1}, Lcom/ironsource/mediationsdk/d;->a(Lorg/json/JSONObject;Lorg/json/JSONObject;)V
