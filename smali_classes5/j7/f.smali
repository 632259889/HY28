...
.method public constructor <init>(Lhhh/aaa/drawpad/DrawingView;)V
    ...
    iput-object p1, p0, Lj7/f;->m:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lj7/f;->s:Ljava/util/ArrayList;

    const/high16 p1, 0x40000000    # 2.0f

    .line 4
    iput p1, p0, Lj7/f;->t:F

    const/high16 p1, 0x41200000    # 10.0f

    .line 5
    iput p1, p0, Lj7/f;->u:F

    const/4 p1, 0x5

    .line 6
    iput p1, p0, Lj7/f;->v:I

    const p1, 0x3dcccccd    # 0.1f

    .line 7
    iput p1, p0, Lj7/f;->w:F
    ...
    iput-object p1, p0, Lj7/f;->o:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lj7/f;->p:Landroid/graphics/Bitmap;

    .line 10
    new-instance p1, Landroid/graphics/Canvas;

    iget-object v0, p0, Lj7/f;->p:Landroid/graphics/Bitmap;

    invoke-direct {p1, v0}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object p1, p0, Lj7/f;->q:Landroid/graphics/Canvas;
    ...
    iput-object p1, p0, Lj7/f;->r:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lj7/f;->C:Landroid/graphics/Paint;

    .line 15
    iget-object p1, p0, Lj7/f;->m:Landroid/graphics/Paint;
    ...
    .line 21
    iget-object p1, p0, Lj7/f;->C:Landroid/graphics/Paint;
...
.method private u(Landroid/graphics/Canvas;Lhhh/aaa/k;Lhhh/aaa/k;Lhhh/aaa/k;Landroid/graphics/Paint;FF)V
    ...
    invoke-direct {p0, v2, v3, v1}, Lj7/f;->w(FFF)F
    ...
    invoke-direct {p0, v3, v4, v1}, Lj7/f;->w(FFF)F
    ...
    invoke-direct {p0, v4, v5, v1}, Lj7/f;->w(FFF)F
    ...
    invoke-direct {p0, v5, v6, v1}, Lj7/f;->w(FFF)F

    move-result v5

    .line 5
    invoke-direct {p0, v2, v4, v1}, Lj7/f;->w(FFF)F

    move-result v2

    .line 6
    invoke-direct {p0, v3, v5, v1}, Lj7/f;->w(FFF)F
...
.method private v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    .line 1
    iget-object v0, p0, Lj7/f;->x:Lhhh/aaa/k;

    iget-object v1, p0, Lj7/f;->y:Lhhh/aaa/k;

    invoke-direct {p0, v0, v1}, Lj7/f;->y(Lhhh/aaa/k;Lhhh/aaa/k;)Lhhh/aaa/k;

    move-result-object v4

    .line 2
    iget-object v0, p0, Lj7/f;->z:Lhhh/aaa/k;

    iget-object v1, p0, Lj7/f;->x:Lhhh/aaa/k;
    ...
    .line 3
    iget-object v5, p0, Lj7/f;->x:Lhhh/aaa/k;
    ...
    invoke-direct/range {v2 .. v9}, Lj7/f;->u(Landroid/graphics/Canvas;Lhhh/aaa/k;Lhhh/aaa/k;Lhhh/aaa/k;Landroid/graphics/Paint;FF)V
...
.method public c(Landroid/graphics/Canvas;Lhhh/aaa/k;)Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lj7/f;->y:Lhhh/aaa/k;

    .line 2
    iget-object v0, p0, Lj7/f;->z:Lhhh/aaa/k;

    iput-object v0, p0, Lj7/f;->x:Lhhh/aaa/k;
    ...
    iput-object v3, p0, Lj7/f;->z:Lhhh/aaa/k;

    .line 7
    iget-object p2, p0, Lj7/f;->x:Lhhh/aaa/k;

    invoke-virtual {v3, p2}, Lhhh/aaa/k;->h(Lhhh/aaa/k;)F
    ...
    .line 11
    :goto_0
    iget p2, p0, Lj7/f;->w:F

    mul-float v1, v1, p2

    sub-float/2addr v4, p2

    iget p2, p0, Lj7/f;->A:F
    ...
    .line 12
    invoke-direct {p0, v1}, Lj7/f;->x(F)F
    ...
    .line 14
    :cond_3
    iget-object v0, p0, Lj7/f;->q:Landroid/graphics/Canvas;

    iget-object v2, p0, Lj7/f;->m:Landroid/graphics/Paint;

    iget v3, p0, Lj7/f;->B:F

    invoke-direct {p0, v0, v2, v3, p2}, Lj7/f;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    .line 15
    iput v1, p0, Lj7/f;->A:F

    .line 16
    iput p2, p0, Lj7/f;->B:F
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lj7/f;->t()Lj7/b;
...
.method public e(Landroid/graphics/Canvas;Lhhh/aaa/k;)Landroid/graphics/Rect;
    ...
    .line 1
    iget-object p1, p0, Lj7/f;->x:Lhhh/aaa/k;

    iput-object p1, p0, Lj7/f;->y:Lhhh/aaa/k;

    .line 2
    iget-object p1, p0, Lj7/f;->z:Lhhh/aaa/k;

    iput-object p1, p0, Lj7/f;->x:Lhhh/aaa/k;
    ...
    iput-object v2, p0, Lj7/f;->z:Lhhh/aaa/k;

    .line 7
    iget-object p1, p0, Lj7/f;->q:Landroid/graphics/Canvas;

    iget-object p2, p0, Lj7/f;->m:Landroid/graphics/Paint;

    iget v0, p0, Lj7/f;->B:F

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v0, v1}, Lj7/f;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
...
.method public s(FFJ)V
    ...
    .line 1
    iget-object v0, p0, Lj7/f;->m:Landroid/graphics/Paint;
    ...
    iput v0, p0, Lj7/f;->w:F

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Lj7/f;->n:Lhhh/aaa/k;

    .line 6
    iget-object v0, p0, Lj7/f;->r:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 7
    iget-object v0, p0, Lj7/f;->s:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 8
    iget-object v0, p0, Lj7/f;->o:Landroid/graphics/Path;
    ...
    .line 13
    iput-object v3, p0, Lj7/f;->x:Lhhh/aaa/k;

    .line 14
    iput-object v3, p0, Lj7/f;->y:Lhhh/aaa/k;

    const/4 p1, 0x0

    .line 15
    iput p1, p0, Lj7/f;->A:F

    .line 16
    invoke-direct {p0, p1}, Lj7/f;->x(F)F
