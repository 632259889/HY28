...
.method public constructor <init>(Lhhh/aaa/drawpad/DrawingView;)V
    ...
    iput-object p1, p0, Lj7/r;->m:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lj7/r;->s:Ljava/util/ArrayList;

    const/high16 p1, 0x40000000    # 2.0f

    .line 4
    iput p1, p0, Lj7/r;->t:F

    const/high16 p1, 0x41200000    # 10.0f

    .line 5
    iput p1, p0, Lj7/r;->u:F

    const/4 p1, 0x5

    .line 6
    iput p1, p0, Lj7/r;->v:I

    const/high16 p1, 0x3f000000    # 0.5f

    .line 7
    iput p1, p0, Lj7/r;->w:F
    ...
    iput-object p1, p0, Lj7/r;->D:Landroid/graphics/Matrix;
    ...
    iput-object p1, p0, Lj7/r;->G:Lhhh/aaa/k;
    ...
    iput-object p1, p0, Lj7/r;->o:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lj7/r;->p:Landroid/graphics/Bitmap;

    .line 12
    new-instance p1, Landroid/graphics/Canvas;

    iget-object v0, p0, Lj7/r;->p:Landroid/graphics/Bitmap;

    invoke-direct {p1, v0}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object p1, p0, Lj7/r;->q:Landroid/graphics/Canvas;
    ...
    iput-object p1, p0, Lj7/r;->r:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lj7/r;->C:Landroid/graphics/Paint;

    .line 17
    iget-object p1, p0, Lj7/r;->m:Landroid/graphics/Paint;
    ...
    .line 23
    iget-object p1, p0, Lj7/r;->C:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, Lj7/r;->n(I)V
...
.method private u(Landroid/graphics/Canvas;Lhhh/aaa/k;Lhhh/aaa/k;Lhhh/aaa/k;Landroid/graphics/Paint;FF)V
    ...
    invoke-direct {p0, v2, v3, v1}, Lj7/r;->x(FFF)F
    ...
    invoke-direct {p0, v3, v4, v1}, Lj7/r;->x(FFF)F
    ...
    invoke-direct {p0, v4, v5, v1}, Lj7/r;->x(FFF)F
    ...
    invoke-direct {p0, v5, v6, v1}, Lj7/r;->x(FFF)F

    move-result v5

    .line 5
    invoke-direct {p0, v2, v4, v1}, Lj7/r;->x(FFF)F

    move-result v2

    .line 6
    invoke-direct {p0, v3, v5, v1}, Lj7/r;->x(FFF)F
    ...
    .line 8
    iget-object v4, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
    ...
    .line 9
    iget-object v5, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
    ...
    .line 10
    iget-object v5, p0, Lj7/r;->D:Landroid/graphics/Matrix;
    ...
    .line 12
    iget-object v4, p0, Lj7/r;->G:Lhhh/aaa/k;

    iget v5, v4, Lhhh/aaa/k;->c:F

    iget v4, v4, Lhhh/aaa/k;->d:F

    invoke-static {v5, v4, v2, v3}, Ln7/h;->a(FFFF)F
    ...
    iput v2, v4, Lhhh/aaa/k;->c:F

    .line 15
    iput v3, v4, Lhhh/aaa/k;->d:F
...
.method private v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    .line 1
    iget-object v0, p0, Lj7/r;->x:Lhhh/aaa/k;

    iget-object v1, p0, Lj7/r;->y:Lhhh/aaa/k;

    invoke-direct {p0, v0, v1}, Lj7/r;->A(Lhhh/aaa/k;Lhhh/aaa/k;)Lhhh/aaa/k;

    move-result-object v4

    .line 2
    iget-object v0, p0, Lj7/r;->z:Lhhh/aaa/k;

    iget-object v1, p0, Lj7/r;->x:Lhhh/aaa/k;
    ...
    .line 3
    iget-object v5, p0, Lj7/r;->x:Lhhh/aaa/k;
    ...
    invoke-direct/range {v2 .. v9}, Lj7/r;->u(Landroid/graphics/Canvas;Lhhh/aaa/k;Lhhh/aaa/k;Lhhh/aaa/k;Landroid/graphics/Paint;FF)V
...
.method private z()V
    ...
    iput-object v0, p0, Lj7/r;->F:Landroid/graphics/Bitmap;
...
.method public c(Landroid/graphics/Canvas;Lhhh/aaa/k;)Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lj7/r;->y:Lhhh/aaa/k;

    .line 2
    iget-object v0, p0, Lj7/r;->z:Lhhh/aaa/k;

    iput-object v0, p0, Lj7/r;->x:Lhhh/aaa/k;
    ...
    iput-object v3, p0, Lj7/r;->z:Lhhh/aaa/k;

    .line 7
    iget-object p2, p0, Lj7/r;->x:Lhhh/aaa/k;
    ...
    .line 8
    iget v0, p0, Lj7/r;->w:F

    mul-float p2, p2, v0

    sub-float/2addr v4, v0

    iget v0, p0, Lj7/r;->A:F
    ...
    .line 9
    invoke-direct {p0, v0}, Lj7/r;->y(F)F

    move-result v0

    .line 10
    iget-object v1, p0, Lj7/r;->q:Landroid/graphics/Canvas;

    iget-object v2, p0, Lj7/r;->m:Landroid/graphics/Paint;

    iget v3, p0, Lj7/r;->B:F

    invoke-direct {p0, v1, v2, v3, v0}, Lj7/r;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    .line 11
    iput p2, p0, Lj7/r;->A:F

    .line 12
    iput v0, p0, Lj7/r;->B:F
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lj7/r;->t()Lj7/b;
...
.method public e(Landroid/graphics/Canvas;Lhhh/aaa/k;)Landroid/graphics/Rect;
    ...
    .line 1
    iget-object p1, p0, Lj7/r;->x:Lhhh/aaa/k;

    iput-object p1, p0, Lj7/r;->y:Lhhh/aaa/k;

    .line 2
    iget-object p1, p0, Lj7/r;->z:Lhhh/aaa/k;

    iput-object p1, p0, Lj7/r;->x:Lhhh/aaa/k;
    ...
    iput-object v2, p0, Lj7/r;->z:Lhhh/aaa/k;

    const/4 p1, 0x0

    .line 7
    invoke-direct {p0, p1}, Lj7/r;->y(F)F

    move-result p1

    .line 8
    iget-object p2, p0, Lj7/r;->q:Landroid/graphics/Canvas;

    iget-object v0, p0, Lj7/r;->m:Landroid/graphics/Paint;

    iget v1, p0, Lj7/r;->B:F

    invoke-direct {p0, p2, v0, v1, p1}, Lj7/r;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
...
.method public n(I)V
    ...
    .line 2
    iget-object v0, p0, Lj7/r;->F:Landroid/graphics/Bitmap;
    ...
    .line 4
    iget-object v1, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
    ...
    .line 7
    :cond_0
    iget-object v1, p0, Lj7/r;->F:Landroid/graphics/Bitmap;
    ...
    .line 8
    invoke-virtual {p0, v0, p1}, Lj7/r;->w(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
...
.method public p(I)V
    ...
    .line 2
    iget-object p1, p0, Lj7/r;->F:Landroid/graphics/Bitmap;

    if-nez p1, :cond_0

    .line 3
    invoke-direct {p0}, Lj7/r;->z()V
    ...
    .line 5
    iget-object v0, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0}, Lj7/r;->w(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v0

    iput-object v0, p0, Lj7/r;->E:Landroid/graphics/Bitmap;
...
.method public s(FFJ)V
    ...
    iput v0, p0, Lj7/r;->v:I

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Lj7/r;->n:Lhhh/aaa/k;

    .line 6
    iget-object v0, p0, Lj7/r;->r:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 7
    iget-object v0, p0, Lj7/r;->s:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 8
    iget-object v0, p0, Lj7/r;->o:Landroid/graphics/Path;
    ...
    .line 13
    iput-object v3, p0, Lj7/r;->x:Lhhh/aaa/k;

    .line 14
    iput-object v3, p0, Lj7/r;->y:Lhhh/aaa/k;

    const/4 p1, 0x0

    .line 15
    iput p1, p0, Lj7/r;->A:F
    ...
    iput p1, p0, Lj7/r;->B:F

    .line 17
    iget-object p1, p0, Lj7/r;->G:Lhhh/aaa/k;

    iget-object p2, p0, Lj7/r;->z:Lhhh/aaa/k;
