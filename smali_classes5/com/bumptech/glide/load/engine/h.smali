...
.method constructor <init>(Lu/h;Lu/a$a;Lv/a;Lv/a;Lv/a;Lv/a;Lcom/bumptech/glide/load/engine/n;Lcom/bumptech/glide/load/engine/l;Lcom/bumptech/glide/load/engine/a;Lcom/bumptech/glide/load/engine/h$b;Lcom/bumptech/glide/load/engine/h$a;Lcom/bumptech/glide/load/engine/s;Z)V
    .locals 11
    ...
    .line 3
    iput-object v8, v7, Lcom/bumptech/glide/load/engine/h;->c:Lu/h;
    ...
    invoke-direct {v9, p2}, Lcom/bumptech/glide/load/engine/h$c;-><init>(Lu/a$a;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/bumptech/glide/load/engine/h$b;-><init>(Lv/a;Lv/a;Lv/a;Lv/a;Lcom/bumptech/glide/load/engine/j;Lcom/bumptech/glide/load/engine/m$a;)V
    ...
    .line 18
    invoke-interface {p1, p0}, Lu/h;->d(Lu/h$a;)V

    return-void
.end method

.method public constructor <init>(Lu/h;Lu/a$a;Lv/a;Lv/a;Lv/a;Lv/a;Z)V
    .locals 14
...
.method private e(Lq/b;)Lcom/bumptech/glide/load/engine/m;
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/h;->c:Lu/h;

    invoke-interface {v0, p1}, Lu/h;->e(Lq/b;)Ls/c;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/bumptech/glide/load/engine/m;-><init>(Ls/c;ZZLq/b;Lcom/bumptech/glide/load/engine/m$a;)V
...
.method private g(Lq/b;)Lcom/bumptech/glide/load/engine/m;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->e(Lq/b;)Lcom/bumptech/glide/load/engine/m;
...
.method private h(Lq/b;)Lcom/bumptech/glide/load/engine/m;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/h;->e(Lq/b;)Lcom/bumptech/glide/load/engine/m;
    ...
    invoke-virtual {v1, p1, v0}, Lcom/bumptech/glide/load/engine/a;->a(Lq/b;Lcom/bumptech/glide/load/engine/m;)V
...
.method private i(Lcom/bumptech/glide/load/engine/k;ZJ)Lcom/bumptech/glide/load/engine/m;
    ...
    .line 1
    :cond_0
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/h;->g(Lq/b;)Lcom/bumptech/glide/load/engine/m;
    ...
    .line 3
    invoke-static {v0, p3, p4, p1}, Lcom/bumptech/glide/load/engine/h;->j(Ljava/lang/String;JLq/b;)V
    ...
    .line 4
    :cond_2
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/h;->h(Lq/b;)Lcom/bumptech/glide/load/engine/m;
...
.method private static j(Ljava/lang/String;JLq/b;)V
    .locals 1
    ...
    invoke-static {p1, p2}, Ll0/g;->a(J)D
...
.method private l(Lcom/bumptech/glide/d;Ljava/lang/Object;Lq/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Ls/a;Ljava/util/Map;ZZLq/e;ZZZZLh0/e;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/k;J)Lcom/bumptech/glide/load/engine/h$d;
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual {v3, v15, v12}, Lcom/bumptech/glide/load/engine/n;->a(Lq/b;Z)Lcom/bumptech/glide/load/engine/i;
    ...
    .line 2
    invoke-virtual {v3, v1, v2}, Lcom/bumptech/glide/load/engine/i;->a(Lh0/e;Ljava/util/concurrent/Executor;)V
    ...
    .line 4
    invoke-static {v2, v13, v14, v15}, Lcom/bumptech/glide/load/engine/h;->j(Ljava/lang/String;JLq/b;)V

    .line 5
    :cond_0
    new-instance v2, Lcom/bumptech/glide/load/engine/h$d;

    invoke-direct {v2, v0, v1, v3}, Lcom/bumptech/glide/load/engine/h$d;-><init>(Lcom/bumptech/glide/load/engine/h;Lh0/e;Lcom/bumptech/glide/load/engine/i;)V
    ...
    .line 7
    invoke-virtual/range {v3 .. v8}, Lcom/bumptech/glide/load/engine/h$b;->a(Lq/b;ZZZZ)Lcom/bumptech/glide/load/engine/i;
    ...
    invoke-virtual {v4, v2, v1}, Lcom/bumptech/glide/load/engine/n;->c(Lq/b;Lcom/bumptech/glide/load/engine/i;)V
    ...
    .line 11
    invoke-virtual {v5, v1, v2}, Lcom/bumptech/glide/load/engine/i;->a(Lh0/e;Ljava/util/concurrent/Executor;)V
    ...
    .line 14
    invoke-static {v2, v6, v7, v4}, Lcom/bumptech/glide/load/engine/h;->j(Ljava/lang/String;JLq/b;)V

    .line 15
    :cond_2
    new-instance v2, Lcom/bumptech/glide/load/engine/h$d;

    invoke-direct {v2, v0, v1, v5}, Lcom/bumptech/glide/load/engine/h$d;-><init>(Lcom/bumptech/glide/load/engine/h;Lh0/e;Lcom/bumptech/glide/load/engine/i;)V
...
.method public a(Ls/c;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/bumptech/glide/load/engine/s;->a(Ls/c;Z)V

    return-void
.end method

.method public declared-synchronized b(Lcom/bumptech/glide/load/engine/i;Lq/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p1}, Lcom/bumptech/glide/load/engine/n;->d(Lq/b;Lcom/bumptech/glide/load/engine/i;)V
    :try_end_0
...
.method public declared-synchronized c(Lcom/bumptech/glide/load/engine/i;Lq/b;Lcom/bumptech/glide/load/engine/m;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p3}, Lcom/bumptech/glide/load/engine/a;->a(Lq/b;Lcom/bumptech/glide/load/engine/m;)V

    .line 3
    :cond_0
    iget-object p3, p0, Lcom/bumptech/glide/load/engine/h;->a:Lcom/bumptech/glide/load/engine/n;

    invoke-virtual {p3, p2, p1}, Lcom/bumptech/glide/load/engine/n;->d(Lq/b;Lcom/bumptech/glide/load/engine/i;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public d(Lq/b;Lcom/bumptech/glide/load/engine/m;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->d(Lq/b;)V
    ...
    invoke-interface {v0, p1, p2}, Lu/h;->c(Lq/b;Ls/c;)Ls/c;
    ...
    invoke-virtual {p1, p2, v0}, Lcom/bumptech/glide/load/engine/s;->a(Ls/c;Z)V

    :goto_0
    return-void
.end method

.method public f(Lcom/bumptech/glide/d;Ljava/lang/Object;Lq/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Ls/a;Ljava/util/Map;ZZLq/e;ZZZZLh0/e;Ljava/util/concurrent/Executor;)Lcom/bumptech/glide/load/engine/h$d;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 3
    invoke-virtual/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/l;->a(Ljava/lang/Object;Lq/b;IILjava/util/Map;Ljava/lang/Class;Ljava/lang/Class;Lq/e;)Lcom/bumptech/glide/load/engine/k;
    ...
    .line 6
    invoke-direct/range {v1 .. v23}, Lcom/bumptech/glide/load/engine/h;->l(Lcom/bumptech/glide/d;Ljava/lang/Object;Lq/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Ls/a;Ljava/util/Map;ZZLq/e;ZZZZLh0/e;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/k;J)Lcom/bumptech/glide/load/engine/h$d;
    ...
    invoke-interface {v3, v1, v0, v2}, Lh0/e;->c(Ls/c;Lcom/bumptech/glide/load/DataSource;Z)V
