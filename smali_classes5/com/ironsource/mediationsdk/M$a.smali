.class public final enum Lcom/ironsource/mediationsdk/M$a;
...
.field private static final synthetic g:[Lcom/ironsource/mediationsdk/M$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/ironsource/mediationsdk/M$a;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/ironsource/mediationsdk/M$a;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ironsource/mediationsdk/M$a;->c:Lcom/ironsource/mediationsdk/M$a;

    new-instance v5, Lcom/ironsource/mediationsdk/M$a;

    const-string v7, "LOAD_IN_PROGRESS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ironsource/mediationsdk/M$a;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ironsource/mediationsdk/M$a;->d:Lcom/ironsource/mediationsdk/M$a;

    new-instance v7, Lcom/ironsource/mediationsdk/M$a;

    const-string v9, "LOADED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/ironsource/mediationsdk/M$a;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/ironsource/mediationsdk/M$a;->e:Lcom/ironsource/mediationsdk/M$a;

    new-instance v9, Lcom/ironsource/mediationsdk/M$a;

    const-string v11, "LOAD_FAILED"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/ironsource/mediationsdk/M$a;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/ironsource/mediationsdk/M$a;->f:Lcom/ironsource/mediationsdk/M$a;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/ironsource/mediationsdk/M$a;
    ...
    sput-object v11, Lcom/ironsource/mediationsdk/M$a;->g:[Lcom/ironsource/mediationsdk/M$a;
