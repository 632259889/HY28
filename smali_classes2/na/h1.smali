...
.method public static final a(Ljava/util/concurrent/Executor;)Lkotlinx/coroutines/CoroutineDispatcher;
    ...
    .line 1
    instance-of v0, p0, Lna/v0;

    if-eqz v0, :cond_0

    move-object v0, p0

    check-cast v0, Lna/v0;
    ...
    iget-object v0, v0, Lna/v0;->a:Lkotlinx/coroutines/CoroutineDispatcher;

    if-nez v0, :cond_2

    :cond_1
    new-instance v0, Lna/g1;

    invoke-direct {v0, p0}, Lna/g1;-><init>(Ljava/util/concurrent/Executor;)V
