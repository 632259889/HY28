.class public Lcom/bytedance/sdk/openadsdk/m/i;
...
.method public static a(Landroid/content/Context;Landroid/hardware/SensorEventListener;)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lcom/bytedance/sdk/openadsdk/m/i;->b(Landroid/content/Context;)Landroid/hardware/SensorManager;
    ...
    .line 6
    invoke-static {p1, v0, p0}, Lcom/bytedance/sdk/openadsdk/m/f;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static a(Landroid/content/Context;Landroid/hardware/SensorEventListener;I)V
    ...
    invoke-static {p2}, Lcom/bytedance/sdk/openadsdk/m/i;->a(I)I
    ...
    .line 3
    invoke-static {p1, p2, p0}, Lcom/bytedance/sdk/openadsdk/m/f;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static b(Landroid/content/Context;)Landroid/hardware/SensorManager;
    ...
    .line 1
    sget-object v0, Lcom/bytedance/sdk/openadsdk/m/i;->a:Landroid/hardware/SensorManager;

    if-nez v0, :cond_1

    .line 2
    const-class v0, Lcom/bytedance/sdk/openadsdk/m/i;

    monitor-enter v0

    .line 3
    :try_start_0
    sget-object v1, Lcom/bytedance/sdk/openadsdk/m/i;->a:Landroid/hardware/SensorManager;
    ...
    sput-object p0, Lcom/bytedance/sdk/openadsdk/m/i;->a:Landroid/hardware/SensorManager;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/bytedance/sdk/openadsdk/m/i;->a:Landroid/hardware/SensorManager;
