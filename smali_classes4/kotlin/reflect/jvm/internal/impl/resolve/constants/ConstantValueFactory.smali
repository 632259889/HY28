...
.method private final b(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/builtins/PrimitiveType;)Lr9/b;
    .locals 2
    ...
    .line 4
    invoke-virtual {p0, v1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/ConstantValueFactory;->c(Ljava/lang/Object;)Lr9/g;
    ...
    invoke-direct {p2, v0, p1}, Lr9/b;-><init>(Ljava/util/List;La8/l;)V
...
# virtual methods
.method public final a(Ljava/util/List;Lca/y;)Lr9/b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/ConstantValueFactory$createArrayValue$1;-><init>(Lca/y;)V

    invoke-direct {v0, p1, v1}, Lr9/b;-><init>(Ljava/util/List;La8/l;)V

    return-object v0
.end method

.method public final c(Ljava/lang/Object;)Lr9/g;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Lr9/d;-><init>(B)V
    ...
    invoke-direct {v0, p1}, Lr9/s;-><init>(S)V
    ...
    invoke-direct {v0, p1}, Lr9/l;-><init>(I)V
    ...
    invoke-direct {v0, v1, v2}, Lr9/p;-><init>(J)V
    ...
    invoke-direct {v0, p1}, Lr9/e;-><init>(C)V
    ...
    invoke-direct {v0, p1}, Lr9/k;-><init>(F)V
    ...
    invoke-direct {v0, v1, v2}, Lr9/h;-><init>(D)V
    ...
    invoke-direct {v0, p1}, Lr9/c;-><init>(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/ConstantValueFactory;->b(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/builtins/PrimitiveType;)Lr9/b;
