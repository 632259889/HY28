...
# direct methods
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;Lda/g;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p1, v6}, Ly9/q;->b(Lj9/c;I)Ll9/e;
    ...
    .line 8
    invoke-direct/range {v1 .. v6}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;-><init>(Ly9/i;Ljava/util/List;Ljava/util/List;Ljava/util/List;La8/a;)V

    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->g:Lda/g;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->h:Lba/h;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->i:Lba/h;

    return-void
.end method

.method public static final synthetic A(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;)Lda/g;
    .locals 0

    .line 1
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->g:Lda/g;

    return-object p0
.end method

.method private final B(Ll9/e;Ljava/util/Collection;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    invoke-virtual {v0}, Ly9/g;->m()Lda/k;
    ...
    .line 5
    invoke-virtual/range {v0 .. v5}, Lkotlin/reflect/jvm/internal/impl/resolve/OverridingUtil;->w(Ll9/e;Ljava/util/Collection;Ljava/util/Collection;Lp8/b;Lp9/g;)V
...
.method public b(Ll9/e;Lx8/b;)Ljava/util/Collection;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->D(Ll9/e;Lx8/b;)V

    .line 2
    invoke-super {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->b(Ll9/e;Lx8/b;)Ljava/util/Collection;
...
.method public c(Ll9/e;Lx8/b;)Ljava/util/Collection;
    ...
    .line 2
    invoke-super {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->c(Ll9/e;Lx8/b;)Ljava/util/Collection;
...
.method public e(Ll9/e;Lx8/b;)Lp8/d;
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$EnumEntryClassDescriptors;->f(Ll9/e;)Lp8/b;
...
.method public g(Lv9/d;La8/l;)Ljava/util/Collection;
    ...
    .line 1
    iget-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->h:Lba/h;
...
.method protected l(Ll9/e;Ljava/util/List;)V
    ...
    .line 2
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->i:Lba/h;
    ...
    invoke-interface {v1, p1, v2}, Lr8/a;->c(Ll9/e;Lp8/b;)Ljava/util/Collection;
    ...
    .line 5
    invoke-direct {p0, p1, v0, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->B(Ll9/e;Ljava/util/Collection;Ljava/util/List;)V
...
.method protected n(Ll9/e;)Ll9/b;
    ...
    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;->O0(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;)Ll9/b;
...
.method protected u()Ljava/util/Set;
    ...
    invoke-virtual {v2}, Ly9/g;->c()Lr8/a;

    move-result-object v2

    invoke-interface {v2, v0}, Lr8/a;->e(Lp8/b;)Ljava/util/Collection;
...
.method protected y(Lkotlin/reflect/jvm/internal/impl/descriptors/f;)Z
    ...
    invoke-virtual {v0}, Ly9/g;->s()Lr8/c;
    ...
    invoke-interface {v0, v1, p1}, Lr8/c;->d(Lp8/b;Lkotlin/reflect/jvm/internal/impl/descriptors/f;)Z
